...
public class InitModel {
    ...
    public ArrayList<Vehicle> createVehicles(){
		...
		vehicles.add(new HybridCar(85990000, "Ford", 2014, 400, 90000,VehicleType.USED,"RPD115",documents,CarType.PICKUP,4,30,true,FuelType.EXTRA,ChargerType.FAST,100));
		...
		vehicles.add(new HybridCar(62000000, "Mazda", 2013, 350, 10000,VehicleType.USED,"HRX731",documents,CarType.PICKUP,4,30,true,FuelType.EXTRA,ChargerType.FAST,75));
